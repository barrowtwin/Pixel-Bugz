...
public class Scout extends Bug {
	...
	private final double SPEED = 60;			// Determines the speed of the bug
	...
	public Scout(double boundX, double boundY, List<List<? extends Enemy>> enemies, double homeX, double homeY, double homeRadius, SynchronizedTrackers trackers) {
